...
with col2:
    ...
    content = """I ,Syed Asad Ali,am a dedicated and results-driven DevOps engineer with a passion for bridging the gap between development and operations to create efficient and reliable software delivery pipelines. With years of experience in the field, I have honed my skills in several key areas."""
    st.info(content)
